<?php if (!empty($users)): ?>
	<table border="0" class="table" cellpadding="0" cellspacing="0">
		<thead>
			<tr>
				<th width="1%" class="align-center"><?php echo form_checkbox(array('name' => 'action_to_all', 'class' => 'check-all'));?></th>
			...
			<?php foreach ($users as $member): ?>
				<tr>
					...
					<td class="actions">
						...
						<?php echo anchor('admin/users/delete/' . $member->id, lang('global:delete'), array('class'=>'confirm button delete','confirm-action'=>'')) ?>
					</td>
				</tr>
			<?php endforeach ?>
		</tbody>
